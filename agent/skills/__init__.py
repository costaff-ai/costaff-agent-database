...
Usage:
    ...
    toolset = load_all_skills()  # returns a SkillToolset (possibly empty)

Currently no skills — placeholder. Drop a `<skill-name>/SKILL.md` into
this folder to add one; it will be loaded automatically.
"""
import logging
